...
// times -- EndgameHastyBot vs EndgameHastyBot, sampling the unknown racks and bag
// -- and records the exact win/loss/draw and final-score-delta distribution. The aggregate
