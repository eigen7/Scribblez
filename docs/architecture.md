...
| Input layout | [input_encoder.h](../engine/include/encoding/input_encoder.h) | The `InputEncodingSpec` + block registry: block order/sizes and layout queries (full layout 88 planes + 207 scalars; base layout 85 + 151). |
