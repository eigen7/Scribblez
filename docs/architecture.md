...
| Input layout | [input_encoder.h](../engine/include/encoding/input_encoder.h) | The `InputEncodingSpec` + block registry: block order/sizes and layout queries (85 planes + 936 scalars, the open-leaves arm adding 27 scalars). |
